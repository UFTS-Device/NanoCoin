...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("gtcoin.io", "dnsseed.gtcoin.io"));
        vSeeds.push_back(CDNSSeedData("gtdot.io", "dnsseed.gtdot.io"));
        vSeeds.push_back(CDNSSeedData("masternode.io", "dnsseed.masternode.io"));
        vSeeds.push_back(CDNSSeedData("gtpay.io", "dnsseed.gtpay.io"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("gtdot.io",  "testnet-seed.gtdot.io"));
